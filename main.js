document.addEventListener('DOMContentLoaded', function init() {//initialize app when webpage is loaded
    ...
    addXPButton.addEventListener('click', function addXP() {//event to add XP
        xp++;//add 1 XP
        ...
        if (xp >= xpRequired) {//check if XP is greater than or equal to XP required
